...
namespace CritRework.Content.Items.Weapons
{
    class GoldJavelin : ModItem
    {
        ...
        public override void SetDefaults()
        {
            Item.damage = 11;
            Item.crit = 35;
            Item.shoot = ModContent.ProjectileType<GoldJavelinProjectile>();
            Item.shootSpeed = 25f;
    ...
    public class GoldJavelinProjectile : ModProjectile
    {
        public override string Texture => "CritRework/Content/Items/Weapons/GoldJavelin";
        ...
        public override void OnKill(int timeLeft)
        {
            if (Main.netMode != NetmodeID.Server)
            {
                for (float i = -1f; i < 1f; i += 1f / 10f)
                {
                    ...
                    Dust d = Dust.NewDustPerfect(position, DustID.Gold, Projectile.velocity / 10f, Scale: (i + 2f) * 0.5f);
                    d.noGravity = true;
                }
            }
        }
