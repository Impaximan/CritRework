...
{
    public class IronChakram : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<IronChakramProjectile>();
            Item.shootSpeed = 15f;
        }
    ...
    public class IronChakramProjectile : ModProjectile
    {
        public override string Texture => "CritRework/Content/Items/Weapons/IronChakram";
