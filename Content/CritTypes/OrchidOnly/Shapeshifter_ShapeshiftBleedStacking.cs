...
namespace CritRework.Content.CritTypes.RandomPool
{
    ...
    internal class Shapeshifter_ShapeshiftBleedStackingSingle : CritType
    {
        ...
        public override bool ShouldCrit(Player Player, Item Item, Projectile? Projectile, NPC target, NPC.HitModifiers modifiers, bool specialPrefix)
        {
            if (ModLoader.TryGetMod("OrchidMod", out Mod OrchidMod))
            {
                ...
                if (target.TryGetGlobalNPC(OrchidMod.Find<GlobalNPC>("ShapeshifterGlobalNPC"), out GlobalNPC g))
                {
